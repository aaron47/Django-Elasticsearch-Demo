...
es_client: Elasticsearch = connections.create_connection(
    cloud_id=settings.ELASTICSEARCH_DSL["cloud"]["cloud_id"],
    http_auth=settings.ELASTICSEARCH_DSL["cloud"]["http_auth"],
)
